...
<head>
    ...
    <title>About Us - CAFFE BrewTopia</title>
...
<!-- Content -->
    <div class="bg-gradient-to-br from-[#4b2c01]/30 to-[#8B4513]/30 container mx-auto px-4 mb-8 py-4">
        <section class="mb-8 text-white">
            <h2 class="text-3xl font-bold mb-4">Welcome to CAFFE BrewTopia</h2>
            <p class="text-white-600 leading-relaxed mb-4">
                Di CAFFE BrewTopia, kami percaya bahwa setiap cangkir kopi memiliki cerita. Kami berdedikasi untuk menyajikan kopi berkualitas tinggi yang tidak hanya memanjakan lidah, tetapi juga memberikan pengalaman yang tak terlupakan.
            </p>
            <p class="text-white-600 leading-relaxed mb-4">
